...
object PizzaAdminServiceGen extends Service.Mixin[PizzaAdminServiceGen, PizzaAdminServiceOperation] {
  ...
  val endpoints: Vector[smithy4s.Endpoint[PizzaAdminServiceOperation, _, _, _, _, _]] = Vector(
    ...
    PizzaAdminServiceOperation.CheckQueryKindXVariantD,
    ...
    PizzaAdminServiceOperation.CheckQueryKindZ,
    PizzaAdminServiceOperation.Health,
    PizzaAdminServiceOperation.CheckQueryKindXVariantC,
    PizzaAdminServiceOperation.GetMenu,
    PizzaAdminServiceOperation.CheckQueryVariantB,
  )
  ...
  implicit final class TransformFunctorOps[F[_]](private val alg: FunctorAlgebra[PizzaAdminServiceGen, F]) extends AnyVal {
    def transform: Transformation.PartiallyApplied[FunctorAlgebra[PizzaAdminServiceGen, F]] = Transformation.of(alg)
  }

  implicit final class TransformBifunctorOps[F[_, _]](private val alg: BiFunctorAlgebra[PizzaAdminServiceGen, F]) extends AnyVal {
    def transform: Transformation.PartiallyApplied[BiFunctorAlgebra[PizzaAdminServiceGen, F]] = Transformation.of(alg)
  }

  implicit final class TransformOps[F[_, _, _, _, _]](private val alg: PizzaAdminServiceGen[F]) extends AnyVal {
    def transform: Transformation.PartiallyApplied[PizzaAdminServiceGen[F]] = Transformation.of(alg)
  }
}
...
object PizzaAdminServiceOperation {
  ...
  class Transformed[P[_, _, _, _, _], P1[_ ,_ ,_ ,_ ,_]](alg: PizzaAdminServiceGen[P], f: PolyFunction5[P, P1]) extends PizzaAdminServiceGen[P1] {
    ...
    def checkQueryKindXVariantD(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryKindXVariantD(inp))
    ...
    def checkQueryVariantA(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryVariantA(inp))
    def checkQueryKindZVariantA(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryKindZVariantA(inp))
    ...
    def checkQueryKindYVariant(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryKindYVariant(inp))
    ...
    def checkQueryKindZ(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryKindZ(inp))
    ...
    def checkQueryKindXVariantC(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryKindXVariantC(inp))
    ...
    def checkQueryVariantB(inp: Option[Map[String, List[String]]] = None): P1[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = f[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing](this.alg.checkQueryVariantB(inp))
  }
  ...
  object OptionalOutput extends smithy4s.Endpoint[PizzaAdminServiceOperation,Unit, Nothing, OptionalOutputOutput, Nothing, Nothing] {
    val schema: OperationSchema[Unit, Nothing, OptionalOutputOutput, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example", "OptionalOutput"))
      ...
      .withHints(Hints.dynamic(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("GET"), "uri" -> smithy4s.Document.fromString("/optional-output"))), Hints.dynamic(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()))
  ...
  object Echo extends smithy4s.Endpoint[PizzaAdminServiceOperation,EchoInput, Nothing, Unit, Nothing, Nothing] {
    val schema: OperationSchema[EchoInput, Nothing, Unit, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example", "Echo"))
      ...
      .withOutput(unit)
      .withHints(Hints.dynamic(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("POST"), "uri" -> smithy4s.Document.fromString("/echo/{pathParam}"))))
    def wrap(input: EchoInput): Echo = Echo(input)
  }
  final case class CheckQueryKindXVariantD(input: CheckQueryInput) extends PizzaAdminServiceOperation[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] {
    def run[F[_, _, _, _, _]](impl: PizzaAdminServiceGen[F]): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = impl.checkQueryKindXVariantD(input.inp)
    def ordinal: Int = 4
    def endpoint: smithy4s.Endpoint[PizzaAdminServiceOperation,CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = CheckQueryKindXVariantD
  }
  object CheckQueryKindXVariantD extends smithy4s.Endpoint[PizzaAdminServiceOperation,CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] {
  ...
  final case class CheckQueryVariantA(input: CheckQueryInput) extends PizzaAdminServiceOperation[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] {
    def run[F[_, _, _, _, _]](impl: PizzaAdminServiceGen[F]): F[CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = impl.checkQueryVariantA(input.inp)
    def ordinal: Int = 8
    def endpoint: smithy4s.Endpoint[PizzaAdminServiceOperation,CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] = CheckQueryVariantA
  }
  object CheckQueryVariantA extends smithy4s.Endpoint[PizzaAdminServiceOperation,CheckQueryInput, Nothing, CheckQueryOutput, Nothing, Nothing] {
  ...
  object HeadRequest extends smithy4s.Endpoint[PizzaAdminServiceOperation,Unit, Nothing, HeadRequestOutput, Nothing, Nothing] {
    val schema: OperationSchema[Unit, Nothing, HeadRequestOutput, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example", "HeadRequest"))
      ...
      .withHints(Hints.dynamic(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("HEAD"), "uri" -> smithy4s.Document.fromString("/head-request"))), Hints.dynamic(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()))
